...
def main():
    ngrok.set_auth_token('your Ngrok auth token')  # Replace with your Ngrok auth token
    ngrok_tunnel = ngrok.connect(addr="8000", proto="http", hostname="your Ngrok domain")
